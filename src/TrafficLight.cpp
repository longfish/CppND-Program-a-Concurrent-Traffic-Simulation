...
void TrafficLight::cycleThroughPhases() {
  ...
  seconds. Also, the while-loop should use std::this_thread::sleep_for to wait
  1ms between two cycles. */

  // pick a random time between 4 and 6 seconds, i.e. [4000, 6000] ms
  ...
  while (true) {
    // sleep for 1ms at every iteration
